...
// V1MachineHardwareExtended v1 machine hardware extended
// swagger:model v1.MachineHardwareExtended
...
func (m *V1MachineHardwareExtended) validateCPUCores(formats strfmt.Registry) error {
...
func (m *V1MachineHardwareExtended) validateDisks(formats strfmt.Registry) error {
...
func (m *V1MachineHardwareExtended) validateMemory(formats strfmt.Registry) error {
...
func (m *V1MachineHardwareExtended) validateNics(formats strfmt.Registry) error {
...
func (m *V1MachineHardwareExtended) UnmarshalBinary(b []byte) error {
	var res V1MachineHardwareExtended
