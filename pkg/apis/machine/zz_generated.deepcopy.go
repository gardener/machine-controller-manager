...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExpectedNodeAttributes) DeepCopyInto(out *ExpectedNodeAttributes) {
	*out = *in
	if in.CPU != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExpectedNodeAttributes.
func (in *ExpectedNodeAttributes) DeepCopy() *ExpectedNodeAttributes {
	if in == nil {
		return nil
	}
	out := new(ExpectedNodeAttributes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MachineClass) DeepCopyInto(out *MachineClass) {
	*out = *in
	...
	if in.ExpectedNodeAttributes != nil {
		in, out := &in.ExpectedNodeAttributes, &out.ExpectedNodeAttributes
		*out = new(ExpectedNodeAttributes)
		(*in).DeepCopyInto(*out)
	}
