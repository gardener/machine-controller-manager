...
func (in *MachineControllerConfig) DeepCopyInto(out *MachineControllerConfig) {
	*out = *in
	...
	if in.MachineSafetyOrphanVMsPeriod != nil {
		in, out := &in.MachineSafetyOrphanVMsPeriod, &out.MachineSafetyOrphanVMsPeriod
		*out = new(metav1.Duration)
		**out = **in
	}
...
func (in *MachineSpec) DeepCopyInto(out *MachineSpec) {
	*out = *in
	...
	if in.MachineControllerConfig != nil {
		in, out := &in.MachineControllerConfig, &out.MachineControllerConfig
		*out = new(MachineControllerConfig)
		(*in).DeepCopyInto(*out)
	}
	return
