...
func (in *MetalMachineClassList) DeepCopyInto(out *MetalMachineClassList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MetalMachineClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MetalMachineClassList) DeepCopy() *MetalMachineClassList {
	if in == nil {
		return nil
	}
	out := new(MetalMachineClassList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetalMachineClassSpec) DeepCopy() *MetalMachineClassSpec {
	if in == nil {
		return nil
	}
	out := new(MetalMachineClassSpec)
	in.DeepCopyInto(out)
	return out
}
