...
const (
	...
	// AnnotationSuspendInstanceDeletionPrefix is the annotation key set on the Machine object that indicates that
	// the deletion of the VM instance shall be suspended after drain.
