...
const (
	...
	// AnnotationSuspendInstanceDeletionPrefix is the annotation key or prefix set on the Machine object to indicate that
	...
	AnnotationSuspendInstanceDeletionPrefix = "suspend-instance-deletion.node.machine.sapcloud.io"
