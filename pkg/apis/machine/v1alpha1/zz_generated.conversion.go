...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MachineControllerConfig)(nil), (*machine.MachineControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MachineControllerConfig_To_machine_MachineControllerConfig(a.(*MachineControllerConfig), b.(*machine.MachineControllerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.MachineControllerConfig)(nil), (*MachineControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_MachineControllerConfig_To_v1alpha1_MachineControllerConfig(a.(*machine.MachineControllerConfig), b.(*MachineControllerConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MachineControllerConfig_To_machine_MachineControllerConfig(in *MachineControllerConfig, out *machine.MachineControllerConfig, s conversion.Scope) error {
	...
	out.MachineSafetyOrphanVMsPeriod = (*metav1.Duration)(unsafe.Pointer(in.MachineSafetyOrphanVMsPeriod))
	out.NodeConditions = (*string)(unsafe.Pointer(in.NodeConditions))
	return nil
}

// Convert_v1alpha1_MachineControllerConfig_To_machine_MachineControllerConfig is an autogenerated conversion function.
func Convert_v1alpha1_MachineControllerConfig_To_machine_MachineControllerConfig(in *MachineControllerConfig, out *machine.MachineControllerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_MachineControllerConfig_To_machine_MachineControllerConfig(in, out, s)
}

func autoConvert_machine_MachineControllerConfig_To_v1alpha1_MachineControllerConfig(in *machine.MachineControllerConfig, out *MachineControllerConfig, s conversion.Scope) error {
	out.MachineDrainTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineDrainTimeout))
	out.MachineHealthTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineHealthTimeout))
	out.MachineCreationTimeout = (*metav1.Duration)(unsafe.Pointer(in.MachineCreationTimeout))
	out.MaxEvictRetries = (*int32)(unsafe.Pointer(in.MaxEvictRetries))
...
// Convert_machine_MachineControllerConfig_To_v1alpha1_MachineControllerConfig is an autogenerated conversion function.
func Convert_machine_MachineControllerConfig_To_v1alpha1_MachineControllerConfig(in *machine.MachineControllerConfig, out *MachineControllerConfig, s conversion.Scope) error {
	return autoConvert_machine_MachineControllerConfig_To_v1alpha1_MachineControllerConfig(in, out, s)
}
...
func autoConvert_v1alpha1_MachineSpec_To_machine_MachineSpec(in *MachineSpec, out *machine.MachineSpec, s conversion.Scope) error {
	...
	out.MachineControllerConfig = (*machine.MachineControllerConfig)(unsafe.Pointer(in.MachineControllerConfig))
	return nil
}
...
func autoConvert_machine_MachineSpec_To_v1alpha1_MachineSpec(in *machine.MachineSpec, out *MachineSpec, s conversion.Scope) error {
	...
	out.MachineControllerConfig = (*MachineControllerConfig)(unsafe.Pointer(in.MachineControllerConfig))
	return nil
}
