...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ExpectedNodeAttributes)(nil), (*machine.ExpectedNodeAttributes)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ExpectedNodeAttributes_To_machine_ExpectedNodeAttributes(a.(*ExpectedNodeAttributes), b.(*machine.ExpectedNodeAttributes), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.ExpectedNodeAttributes)(nil), (*ExpectedNodeAttributes)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_ExpectedNodeAttributes_To_v1alpha1_ExpectedNodeAttributes(a.(*machine.ExpectedNodeAttributes), b.(*ExpectedNodeAttributes), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ExpectedNodeAttributes_To_machine_ExpectedNodeAttributes(in *ExpectedNodeAttributes, out *machine.ExpectedNodeAttributes, s conversion.Scope) error {
	out.CPU = (*int64)(unsafe.Pointer(in.CPU))
	out.GPU = (*int64)(unsafe.Pointer(in.GPU))
	out.InstanceType = (*string)(unsafe.Pointer(in.InstanceType))
	out.Memory = (*int64)(unsafe.Pointer(in.Memory))
	out.Region = (*string)(unsafe.Pointer(in.Region))
	out.Zone = (*string)(unsafe.Pointer(in.Zone))
	return nil
}

// Convert_v1alpha1_ExpectedNodeAttributes_To_machine_ExpectedNodeAttributes is an autogenerated conversion function.
func Convert_v1alpha1_ExpectedNodeAttributes_To_machine_ExpectedNodeAttributes(in *ExpectedNodeAttributes, out *machine.ExpectedNodeAttributes, s conversion.Scope) error {
	return autoConvert_v1alpha1_ExpectedNodeAttributes_To_machine_ExpectedNodeAttributes(in, out, s)
}

func autoConvert_machine_ExpectedNodeAttributes_To_v1alpha1_ExpectedNodeAttributes(in *machine.ExpectedNodeAttributes, out *ExpectedNodeAttributes, s conversion.Scope) error {
	out.CPU = (*int64)(unsafe.Pointer(in.CPU))
	out.GPU = (*int64)(unsafe.Pointer(in.GPU))
	out.InstanceType = (*string)(unsafe.Pointer(in.InstanceType))
	out.Memory = (*int64)(unsafe.Pointer(in.Memory))
...
// Convert_machine_ExpectedNodeAttributes_To_v1alpha1_ExpectedNodeAttributes is an autogenerated conversion function.
func Convert_machine_ExpectedNodeAttributes_To_v1alpha1_ExpectedNodeAttributes(in *machine.ExpectedNodeAttributes, out *ExpectedNodeAttributes, s conversion.Scope) error {
	return autoConvert_machine_ExpectedNodeAttributes_To_v1alpha1_ExpectedNodeAttributes(in, out, s)
}
...
func autoConvert_v1alpha1_MachineClass_To_machine_MachineClass(in *MachineClass, out *machine.MachineClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.CredentialsSecretRef = (*v1.SecretReference)(unsafe.Pointer(in.CredentialsSecretRef))
	out.ExpectedNodeAttributes = (*machine.ExpectedNodeAttributes)(unsafe.Pointer(in.ExpectedNodeAttributes))
...
func autoConvert_machine_MachineClass_To_v1alpha1_MachineClass(in *machine.MachineClass, out *MachineClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.CredentialsSecretRef = (*v1.SecretReference)(unsafe.Pointer(in.CredentialsSecretRef))
	out.ExpectedNodeAttributes = (*ExpectedNodeAttributes)(unsafe.Pointer(in.ExpectedNodeAttributes))
	out.Provider = in.Provider
	out.ProviderSpec = in.ProviderSpec
	out.SecretRef = (*v1.SecretReference)(unsafe.Pointer(in.SecretRef))
	return nil
