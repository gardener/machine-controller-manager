...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MetalMachineClass)(nil), (*machine.MetalMachineClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MetalMachineClass_To_machine_MetalMachineClass(a.(*MetalMachineClass), b.(*machine.MetalMachineClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.MetalMachineClass)(nil), (*MetalMachineClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_MetalMachineClass_To_v1alpha1_MetalMachineClass(a.(*machine.MetalMachineClass), b.(*MetalMachineClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*MetalMachineClassList)(nil), (*machine.MetalMachineClassList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MetalMachineClassList_To_machine_MetalMachineClassList(a.(*MetalMachineClassList), b.(*machine.MetalMachineClassList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.MetalMachineClassList)(nil), (*MetalMachineClassList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_MetalMachineClassList_To_v1alpha1_MetalMachineClassList(a.(*machine.MetalMachineClassList), b.(*MetalMachineClassList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*MetalMachineClassSpec)(nil), (*machine.MetalMachineClassSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(a.(*MetalMachineClassSpec), b.(*machine.MetalMachineClassSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.MetalMachineClassSpec)(nil), (*MetalMachineClassSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec(a.(*machine.MetalMachineClassSpec), b.(*MetalMachineClassSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MetalMachineClass_To_machine_MetalMachineClass(in *MetalMachineClass, out *machine.MetalMachineClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_MetalMachineClass_To_machine_MetalMachineClass is an autogenerated conversion function.
func Convert_v1alpha1_MetalMachineClass_To_machine_MetalMachineClass(in *MetalMachineClass, out *machine.MetalMachineClass, s conversion.Scope) error {
	return autoConvert_v1alpha1_MetalMachineClass_To_machine_MetalMachineClass(in, out, s)
}

func autoConvert_machine_MetalMachineClass_To_v1alpha1_MetalMachineClass(in *machine.MetalMachineClass, out *MetalMachineClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_machine_MetalMachineClass_To_v1alpha1_MetalMachineClass is an autogenerated conversion function.
func Convert_machine_MetalMachineClass_To_v1alpha1_MetalMachineClass(in *machine.MetalMachineClass, out *MetalMachineClass, s conversion.Scope) error {
	return autoConvert_machine_MetalMachineClass_To_v1alpha1_MetalMachineClass(in, out, s)
}

func autoConvert_v1alpha1_MetalMachineClassList_To_machine_MetalMachineClassList(in *MetalMachineClassList, out *machine.MetalMachineClassList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]machine.MetalMachineClass)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_MetalMachineClassList_To_machine_MetalMachineClassList is an autogenerated conversion function.
func Convert_v1alpha1_MetalMachineClassList_To_machine_MetalMachineClassList(in *MetalMachineClassList, out *machine.MetalMachineClassList, s conversion.Scope) error {
	return autoConvert_v1alpha1_MetalMachineClassList_To_machine_MetalMachineClassList(in, out, s)
}

func autoConvert_machine_MetalMachineClassList_To_v1alpha1_MetalMachineClassList(in *machine.MetalMachineClassList, out *MetalMachineClassList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]MetalMachineClass)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_machine_MetalMachineClassList_To_v1alpha1_MetalMachineClassList is an autogenerated conversion function.
func Convert_machine_MetalMachineClassList_To_v1alpha1_MetalMachineClassList(in *machine.MetalMachineClassList, out *MetalMachineClassList, s conversion.Scope) error {
	return autoConvert_machine_MetalMachineClassList_To_v1alpha1_MetalMachineClassList(in, out, s)
}

func autoConvert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(in *MetalMachineClassSpec, out *machine.MetalMachineClassSpec, s conversion.Scope) error {
...
// Convert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec is an autogenerated conversion function.
func Convert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(in *MetalMachineClassSpec, out *machine.MetalMachineClassSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(in, out, s)
}

func autoConvert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec(in *machine.MetalMachineClassSpec, out *MetalMachineClassSpec, s conversion.Scope) error {
	out.Partition = in.Partition
	out.Size = in.Size
	out.Image = in.Image
	out.Project = in.Project
...
// Convert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec is an autogenerated conversion function.
func Convert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec(in *machine.MetalMachineClassSpec, out *MetalMachineClassSpec, s conversion.Scope) error {
	return autoConvert_machine_MetalMachineClassSpec_To_v1alpha1_MetalMachineClassSpec(in, out, s)
}
