...
type MachineTemplateSpec struct {
	...
	// More info: https://git.k8s.io/contributors/devel/sig-architecture/api-conventions.md#metadata
	metav1.ObjectMeta

	// Specification of the desired behavior of the machine.
	// More info: https://git.k8s.io/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	Spec MachineSpec
}
...
type MachineTemplate struct {
	...
	// https://git.k8s.io/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
...
type MachineTemplateList struct {
	...
	// More info: https://git.k8s.io/contributors/devel/sig-architecture/api-conventions.md#types-kinds
	metav1.ListMeta
