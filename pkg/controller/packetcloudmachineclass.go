...
func (c *controller) reconcileClusterPacketMachineClass(class *v1alpha1.PacketMachineClass) error {
	...
	if class.DeletionTimestamp == nil {
		...
		if c.deleteMigratedMachineClass && annotationPresent && len(machines) == 0 {
			...
			err = c.controlMachineClient.PacketMachineClasses(class.Namespace).Delete(context.TODO(), class.Name, metav1.DeleteOptions{})
			if err != nil {
				return err
			}
...
func (c *controller) updatePacketMachineClassFinalizers(class *v1alpha1.PacketMachineClass, finalizers []string) error {
	...
	class, err := c.controlMachineClient.PacketMachineClasses(class.Namespace).Get(context.TODO(), class.Name, metav1.GetOptions{})
	if err != nil {
		return err
	}
	...
	_, err = c.controlMachineClient.PacketMachineClasses(class.Namespace).Update(context.TODO(), clone, metav1.UpdateOptions{})
	if err != nil {
