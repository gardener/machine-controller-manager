...
func (c *controller) addBootstrapTokenToUserData(machineName string, secret *corev1.Secret) error {
	var (
		userDataB []byte
		userDataS string
		exists    bool
...
func (c *controller) getBootstrapTokenOrCreateIfNotExist(machineName string) (secret *corev1.Secret, err error) {
