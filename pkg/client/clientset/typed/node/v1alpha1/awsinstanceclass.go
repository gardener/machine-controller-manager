...
type AWSInstanceClassInterface interface {
	Create(*v1alpha1.AWSInstanceClass) (*v1alpha1.AWSInstanceClass, error)
	Update(*v1alpha1.AWSInstanceClass) (*v1alpha1.AWSInstanceClass, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.AWSInstanceClass, error)
	List(opts v1.ListOptions) (*v1alpha1.AWSInstanceClassList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AWSInstanceClass, err error)
...
func newAWSInstanceClasses(c *NodeV1alpha1Client) *aWSInstanceClasses {
...
func (c *aWSInstanceClasses) Get(name string, options v1.GetOptions) (result *v1alpha1.AWSInstanceClass, err error) {
	result = &v1alpha1.AWSInstanceClass{}
	err = c.client.Get().
...
func (c *aWSInstanceClasses) List(opts v1.ListOptions) (result *v1alpha1.AWSInstanceClassList, err error) {
	result = &v1alpha1.AWSInstanceClassList{}
	err = c.client.Get().
		Resource("awsinstanceclasses").
...
func (c *aWSInstanceClasses) Create(aWSInstanceClass *v1alpha1.AWSInstanceClass) (result *v1alpha1.AWSInstanceClass, err error) {
	result = &v1alpha1.AWSInstanceClass{}
	err = c.client.Post().
		Resource("awsinstanceclasses").
...
func (c *aWSInstanceClasses) Update(aWSInstanceClass *v1alpha1.AWSInstanceClass) (result *v1alpha1.AWSInstanceClass, err error) {
	result = &v1alpha1.AWSInstanceClass{}
	err = c.client.Put().
		Resource("awsinstanceclasses").
...
func (c *aWSInstanceClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AWSInstanceClass, err error) {
	result = &v1alpha1.AWSInstanceClass{}
