...
var machinesResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "", Resource: "machines"}

var machinesKind = schema.GroupVersionKind{Group: "cluster.k8s.io", Version: "", Kind: "Machine"}
