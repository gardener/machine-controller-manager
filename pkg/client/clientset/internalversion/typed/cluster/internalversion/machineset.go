...
type MachineSetInterface interface {
	Create(*cluster.MachineSet) (*cluster.MachineSet, error)
	Update(*cluster.MachineSet) (*cluster.MachineSet, error)
	UpdateStatus(*cluster.MachineSet) (*cluster.MachineSet, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*cluster.MachineSet, error)
	List(opts v1.ListOptions) (*cluster.MachineSetList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cluster.MachineSet, err error)
	MachineSetExpansion
}
...
func newMachineSets(c *ClusterClient, namespace string) *machineSets {
	return &machineSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *machineSets) Get(name string, options v1.GetOptions) (result *cluster.MachineSet, err error) {
	result = &cluster.MachineSet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineSets) List(opts v1.ListOptions) (result *cluster.MachineSetList, err error) {
	result = &cluster.MachineSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machinesets").
...
func (c *machineSets) Create(machineSet *cluster.MachineSet) (result *cluster.MachineSet, err error) {
	result = &cluster.MachineSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machinesets").
...
func (c *machineSets) Update(machineSet *cluster.MachineSet) (result *cluster.MachineSet, err error) {
	result = &cluster.MachineSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinesets").
...
func (c *machineSets) UpdateStatus(machineSet *cluster.MachineSet) (result *cluster.MachineSet, err error) {
	result = &cluster.MachineSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinesets").
...
func (c *machineSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cluster.MachineSet, err error) {
	result = &cluster.MachineSet{}
