...
type MachineDeploymentInterface interface {
	Create(*cluster.MachineDeployment) (*cluster.MachineDeployment, error)
	Update(*cluster.MachineDeployment) (*cluster.MachineDeployment, error)
	UpdateStatus(*cluster.MachineDeployment) (*cluster.MachineDeployment, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*cluster.MachineDeployment, error)
	List(opts v1.ListOptions) (*cluster.MachineDeploymentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cluster.MachineDeployment, err error)
...
func newMachineDeployments(c *ClusterClient, namespace string) *machineDeployments {
...
func (c *machineDeployments) Get(name string, options v1.GetOptions) (result *cluster.MachineDeployment, err error) {
	result = &cluster.MachineDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineDeployments) List(opts v1.ListOptions) (result *cluster.MachineDeploymentList, err error) {
	result = &cluster.MachineDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machinedeployments").
...
func (c *machineDeployments) Create(machineDeployment *cluster.MachineDeployment) (result *cluster.MachineDeployment, err error) {
	result = &cluster.MachineDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machinedeployments").
...
func (c *machineDeployments) Update(machineDeployment *cluster.MachineDeployment) (result *cluster.MachineDeployment, err error) {
	result = &cluster.MachineDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinedeployments").
...
func (c *machineDeployments) UpdateStatus(machineDeployment *cluster.MachineDeployment) (result *cluster.MachineDeployment, err error) {
	result = &cluster.MachineDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinedeployments").
...
func (c *machineDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cluster.MachineDeployment, err error) {
	result = &cluster.MachineDeployment{}
