...
func (c *alicloudMachineClasses) Get(name string, options v1.GetOptions) (result *machine.AlicloudMachineClass, err error) {
...
func (c *alicloudMachineClasses) List(opts v1.ListOptions) (result *machine.AlicloudMachineClassList, err error) {
...
func (c *alicloudMachineClasses) Create(alicloudMachineClass *machine.AlicloudMachineClass) (result *machine.AlicloudMachineClass, err error) {
	result = &machine.AlicloudMachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alicloudmachineclasses").
...
func (c *alicloudMachineClasses) Update(alicloudMachineClass *machine.AlicloudMachineClass) (result *machine.AlicloudMachineClass, err error) {
	result = &machine.AlicloudMachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alicloudmachineclasses").
...
func (c *alicloudMachineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.AlicloudMachineClass, err error) {
	result = &machine.AlicloudMachineClass{}
