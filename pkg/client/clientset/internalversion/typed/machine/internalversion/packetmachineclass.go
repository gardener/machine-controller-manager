...
func (c *packetMachineClasses) Get(name string, options v1.GetOptions) (result *machine.PacketMachineClass, err error) {
...
func (c *packetMachineClasses) Create(packetMachineClass *machine.PacketMachineClass) (result *machine.PacketMachineClass, err error) {
	result = &machine.PacketMachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packetmachineclasses").
...
func (c *packetMachineClasses) Update(packetMachineClass *machine.PacketMachineClass) (result *machine.PacketMachineClass, err error) {
	result = &machine.PacketMachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packetmachineclasses").
...
func (c *packetMachineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.PacketMachineClass, err error) {
	result = &machine.PacketMachineClass{}
