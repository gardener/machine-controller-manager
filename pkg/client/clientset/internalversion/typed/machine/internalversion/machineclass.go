...
func newMachineClasses(c *MachineClient, namespace string) *machineClasses {
...
func (c *machineClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineClasses) List(ctx context.Context, opts v1.ListOptions) (result *machine.MachineClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &machine.MachineClassList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Create(ctx context.Context, machineClass *machine.MachineClass, opts v1.CreateOptions) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Update(ctx context.Context, machineClass *machine.MachineClass, opts v1.UpdateOptions) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
