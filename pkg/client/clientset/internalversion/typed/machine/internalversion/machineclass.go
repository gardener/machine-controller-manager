...
func (c *machineClasses) Get(name string, options v1.GetOptions) (result *machine.MachineClass, err error) {
...
func (c *machineClasses) List(opts v1.ListOptions) (result *machine.MachineClassList, err error) {
...
func (c *machineClasses) Create(machineClass *machine.MachineClass) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Update(machineClass *machine.MachineClass) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineclasses").
...
func (c *machineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.MachineClass, err error) {
	result = &machine.MachineClass{}
