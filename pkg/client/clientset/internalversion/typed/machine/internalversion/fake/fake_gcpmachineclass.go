...
func (c *FakeGCPMachineClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *machine.GCPMachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeGCPMachineClasses) List(ctx context.Context, opts v1.ListOptions) (result *machine.GCPMachineClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeGCPMachineClasses) Create(ctx context.Context, gCPMachineClass *machine.GCPMachineClass, opts v1.CreateOptions) (result *machine.GCPMachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeGCPMachineClasses) Update(ctx context.Context, gCPMachineClass *machine.GCPMachineClass, opts v1.UpdateOptions) (result *machine.GCPMachineClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeGCPMachineClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *machine.GCPMachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(gcpmachineclassesResource, c.ns, name, pt, data, subresources...), &machine.GCPMachineClass{})
