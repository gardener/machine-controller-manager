...
func (c *FakeMachineSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineSets) List(ctx context.Context, opts v1.ListOptions) (result *machine.MachineSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineSets) Create(ctx context.Context, machineSet *machine.MachineSet, opts v1.CreateOptions) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineSets) Update(ctx context.Context, machineSet *machine.MachineSet, opts v1.UpdateOptions) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineSets) UpdateStatus(ctx context.Context, machineSet *machine.MachineSet, opts v1.UpdateOptions) (*machine.MachineSet, error) {
	obj, err := c.Fake.
...
func (c *FakeMachineSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(machinesetsResource, c.ns, name, opts), &machine.MachineSet{})
...
func (c *FakeMachineSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
