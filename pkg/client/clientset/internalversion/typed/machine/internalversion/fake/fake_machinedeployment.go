...
func (c *FakeMachineDeployments) Get(name string, options v1.GetOptions) (result *machine.MachineDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machinedeploymentsResource, name), &machine.MachineDeployment{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineDeployments) List(opts v1.ListOptions) (result *machine.MachineDeploymentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(machinedeploymentsResource, machinedeploymentsKind, opts), &machine.MachineDeploymentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineDeployments) Create(machineDeployment *machine.MachineDeployment) (result *machine.MachineDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(machinedeploymentsResource, machineDeployment), &machine.MachineDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineDeployment), err
...
func (c *FakeMachineDeployments) Update(machineDeployment *machine.MachineDeployment) (result *machine.MachineDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(machinedeploymentsResource, machineDeployment), &machine.MachineDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineDeployment), err
...
func (c *FakeMachineDeployments) UpdateStatus(machineDeployment *machine.MachineDeployment) (*machine.MachineDeployment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(machinedeploymentsResource, "status", machineDeployment), &machine.MachineDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineDeployment), err
...
func (c *FakeMachineDeployments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(machinedeploymentsResource, name), &machine.MachineDeployment{})
	return err
}
...
func (c *FakeMachineDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.MachineDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machinedeploymentsResource, name, data, subresources...), &machine.MachineDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineDeployment), err
...
func (c *FakeMachineDeployments) GetScale(machineDeploymentName string, options v1.GetOptions) (result *machine.Scale, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machinedeploymentsResource, machineDeploymentName), &machine.Scale{})
	if obj == nil {
		return nil, err
	}
