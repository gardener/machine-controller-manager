...
func (c *ClusterV1alpha1Client) AWSMachineClasses(namespace string) AWSMachineClassInterface {
	return newAWSMachineClasses(c, namespace)
}

func (c *ClusterV1alpha1Client) AzureMachineClasses(namespace string) AzureMachineClassInterface {
...
func (c *ClusterV1alpha1Client) GCPMachineClasses(namespace string) GCPMachineClassInterface {
...
func (c *ClusterV1alpha1Client) OpenStackMachineClasses(namespace string) OpenStackMachineClassInterface {
