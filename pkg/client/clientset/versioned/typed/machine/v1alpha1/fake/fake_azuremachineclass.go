...
func (c *FakeAzureMachineClasses) Get(name string, options v1.GetOptions) (result *v1alpha1.AzureMachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(azuremachineclassesResource, name), &v1alpha1.AzureMachineClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAzureMachineClasses) List(opts v1.ListOptions) (result *v1alpha1.AzureMachineClassList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(azuremachineclassesResource, azuremachineclassesKind, opts), &v1alpha1.AzureMachineClassList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAzureMachineClasses) Create(azureMachineClass *v1alpha1.AzureMachineClass) (result *v1alpha1.AzureMachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(azuremachineclassesResource, azureMachineClass), &v1alpha1.AzureMachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AzureMachineClass), err
...
func (c *FakeAzureMachineClasses) Update(azureMachineClass *v1alpha1.AzureMachineClass) (result *v1alpha1.AzureMachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(azuremachineclassesResource, azureMachineClass), &v1alpha1.AzureMachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AzureMachineClass), err
...
func (c *FakeAzureMachineClasses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(azuremachineclassesResource, name), &v1alpha1.AzureMachineClass{})
	return err
}
...
func (c *FakeAzureMachineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AzureMachineClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(azuremachineclassesResource, name, data, subresources...), &v1alpha1.AzureMachineClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AzureMachineClass), err
