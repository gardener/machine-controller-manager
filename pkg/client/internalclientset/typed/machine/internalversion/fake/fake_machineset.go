...
func (c *FakeMachineSets) Get(name string, options v1.GetOptions) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machinesetsResource, name), &machine.MachineSet{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineSets) List(opts v1.ListOptions) (result *machine.MachineSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(machinesetsResource, machinesetsKind, opts), &machine.MachineSetList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachineSets) Create(machineSet *machine.MachineSet) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(machinesetsResource, machineSet), &machine.MachineSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineSet), err
...
func (c *FakeMachineSets) Update(machineSet *machine.MachineSet) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(machinesetsResource, machineSet), &machine.MachineSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineSet), err
...
func (c *FakeMachineSets) UpdateStatus(machineSet *machine.MachineSet) (*machine.MachineSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(machinesetsResource, "status", machineSet), &machine.MachineSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineSet), err
...
func (c *FakeMachineSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(machinesetsResource, name), &machine.MachineSet{})
	return err
}
...
func (c *FakeMachineSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.MachineSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machinesetsResource, name, data, subresources...), &machine.MachineSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.MachineSet), err
