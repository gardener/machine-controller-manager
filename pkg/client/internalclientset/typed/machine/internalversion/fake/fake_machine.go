...
func (c *FakeMachines) Get(name string, options v1.GetOptions) (result *machine.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(machinesResource, name), &machine.Machine{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachines) List(opts v1.ListOptions) (result *machine.MachineList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(machinesResource, machinesKind, opts), &machine.MachineList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeMachines) Create(machine *machine.Machine) (result *machine.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(machinesResource, machine), &machine.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.Machine), err
...
func (c *FakeMachines) Update(machine *machine.Machine) (result *machine.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(machinesResource, machine), &machine.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.Machine), err
...
func (c *FakeMachines) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(machinesResource, name), &machine.Machine{})
	return err
}
...
func (c *FakeMachines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *machine.Machine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(machinesResource, name, data, subresources...), &machine.Machine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*machine.Machine), err
