...
import (
	...
	cluster_v1alpha1 "github.com/gardener/machine-controller-manager/pkg/apis/cluster/v1alpha1"
	...
	v1alpha1 "github.com/gardener/machine-controller-manager/pkg/client/listers/cluster/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1alpha1().OpenStackMachineClasses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1alpha1().OpenStackMachineClasses(namespace).Watch(options)
			},
		},
		&cluster_v1alpha1.OpenStackMachineClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *openStackMachineClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cluster_v1alpha1.OpenStackMachineClass{}, f.defaultInformer)
}
