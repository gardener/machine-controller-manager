...
<<<<<<< HEAD
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClass": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MetalMachineClass TODO",
					Properties: map[string]spec.Schema{
						"metadata": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"),
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClassSpec"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClassSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClassList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MetalMachineClassList is a collection of MetalMachineClasses.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClass"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClass", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MetalMachineClassSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MetalMachineClassSpec is the specification of a cluster.",
					Properties: map[string]spec.Schema{
						"partition": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
