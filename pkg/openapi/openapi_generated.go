...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.InPlaceUpdateMachineDeployment": schema_pkg_apis_machine_v1alpha1_InPlaceUpdateMachineDeployment(ref),
...
func schema_pkg_apis_machine_v1alpha1_InPlaceUpdateMachineDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"orchestrationType": {
						SchemaProps: spec.SchemaProps{
							Description: "OrchestrationType specifies the orchestration type for the inplace update.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_machine_v1alpha1_Machine(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineSpec", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineClass(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.NodeTemplate", v1.SecretReference{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName(), runtime.RawExtension{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineClassList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineClass", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineDeploymentSpec", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineDeploymentStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineDeploymentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineDeployment", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineDeploymentStrategy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"inPlaceUpdate": {
						SchemaProps: spec.SchemaProps{
							Description: "InPlaceUpdate update config params. Present only if MachineDeploymentStrategyType = InPlaceUpdate.",
							Ref:         ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.InPlaceUpdateMachineDeployment"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.InPlaceUpdateMachineDeployment", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.RollingUpdateMachineDeployment"},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.Machine", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineSet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineSetSpec", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineSetStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineSetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineSet", metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineSetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.ClassSpec", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineTemplateSpec", metav1.LabelSelector{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.ClassSpec", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.NodeTemplateSpec", metav1.Duration{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.CurrentStatus", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.LastOperation", v1.NodeAddress{}.OpenAPIModelName(), v1.NodeCondition{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_MachineTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.MachineSpec", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_machine_v1alpha1_NodeTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.NodeSpec{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_machine_v1alpha1_RollbackConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_machine_v1alpha1_RollingUpdateMachineDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_machine_v1alpha1_UpdateConfiguration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
